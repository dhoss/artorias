...
public class Post extends TableImpl<PostRecord> {
    ...
    private static final long serialVersionUID = 1471021160;
     ...
     */
    public final TableField<PostRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('blog.post_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<PostRecord, Integer> AUTHOR = createField("author", org.jooq.impl.SQLDataType.INTEGER, this, "");
