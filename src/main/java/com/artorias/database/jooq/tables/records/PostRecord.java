...
public class PostRecord extends UpdatableRecordImpl<PostRecord> implements Record7<Integer, String, String, Integer, Timestamp, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1767902238;
     ...
     */
    public PostRecord(Integer postId, String title, String body, Integer authorId, Timestamp createdOn, Timestamp updatedOn, Timestamp publishedOn) {
        super(Post.POST);
